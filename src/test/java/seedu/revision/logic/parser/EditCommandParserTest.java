...
import static seedu.revision.logic.commands.CommandTestUtil.ADDRESS_DESC_AMY;
import static seedu.revision.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static seedu.revision.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static seedu.revision.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.revision.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.revision.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.revision.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.revision.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static seedu.revision.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.revision.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.revision.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static seedu.revision.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static seedu.revision.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.revision.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditAnswerableDescriptor descriptor = new EditAnswerableDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditAnswerableDescriptor descriptor = new EditAnswerableDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditAnswerableDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_AMY;
        descriptor = new EditAnswerableDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditAnswerableDescriptor descriptor = new EditAnswerableDescriptorBuilder().withPhone(VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
        descriptor = new EditAnswerableDescriptorBuilder().withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
