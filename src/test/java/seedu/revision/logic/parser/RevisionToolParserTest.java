...
public class RevisionToolParserTest {

    private final RevisionToolParser parser = new RevisionToolParser();
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + INDEX_FIRST_ANSWERABLE.getOneBased() + " "
                + AnswerableUtil.getEditAnswerableDescriptorDetails(descriptor));
