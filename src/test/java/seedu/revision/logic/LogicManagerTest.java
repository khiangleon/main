...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonRevisionToolStorage revisionToolStorage =
                new JsonRevisionToolStorage(temporaryFolder.resolve("revisionTool.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(revisionToolStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonRevisionToolStorage revisionToolStorage =
                new JsonRevisionToolIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionRevisionTool.json"));
