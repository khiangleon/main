...
class JsonAdaptedAnswerable {
     ...
     */
    @JsonCreator
    public JsonAdaptedAnswerable(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
    ...
    public Answerable toModelType() throws IllegalValueException {
        ...
        return new Answerable(modelName, modelPhone, modelEmail, modelAddress, modelTags);
    }
