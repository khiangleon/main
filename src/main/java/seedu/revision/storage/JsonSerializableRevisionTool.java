...
class JsonSerializableRevisionTool {
    ...
    public static final String MESSAGE_DUPLICATE_ANSWERABLE = "Questions list contains duplicate question(s).";
    ...
    public JsonSerializableRevisionTool(ReadOnlyRevisionTool source) {
        answerables.addAll(source.getAnswerableList().stream().map(JsonAdaptedAnswerable::new)
