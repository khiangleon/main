...
/**
 * An UI component that displays information of an {@code Answerable}.
 */
public class AnswerableCard extends UiPart<Region> {
    ...
    public AnswerableCard(Answerable answerable, int displayedIndex) {
        ...
        name.setText(answerable.getName().fullName);
        phone.setText(answerable.getPhone().value);
        address.setText(answerable.getAddress().value);
        email.setText(answerable.getEmail().value);
