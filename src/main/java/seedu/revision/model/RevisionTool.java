...
public class RevisionTool implements ReadOnlyRevisionTool {
    ...
    /**
     * Creates a RevisionTool using the Answerables in the {@code toBeCopied}
     */
    ...
    /**
     * Returns true if an answerable with the same identity as {@code answerable} exists in the revision tool.
     */
     ...
     * The answerable identity of {@code editedAnswerable} must not be the same as another existing answerable
     * in the revision tool.
     */
    ...
    public String toString() {
        return answerables.asUnmodifiableObservableList().size() + " questions";
        // TODO: refine later
    }
