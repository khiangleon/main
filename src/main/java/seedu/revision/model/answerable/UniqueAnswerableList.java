 ...
 * An answerable is considered unique by comparing using {@code Answerable#isSameAnswerable(Answerable)}.
 ...
 * UniqueAnswerableList. However, the removal of an answerable uses Answerable#equals(Object) so
...
public class UniqueAnswerableList implements Iterable<Answerable> {
    ...
    /**
     * Adds an answerable to the list.
