...
/**
 * Deletes an answerable identified using it's displayed index from the revision tool.
 */
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_ANSWERABLE_SUCCESS = "Deleted Question: %1$s";
