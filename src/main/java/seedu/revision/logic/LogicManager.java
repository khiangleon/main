...
import seedu.revision.logic.parser.RevisionToolParser;
...
public class LogicManager implements Logic {
    ...
    private final RevisionToolParser revisionToolParser;

    public LogicManager(Model model, Storage storage) {
        this.model = model;
        this.storage = storage;
        revisionToolParser = new RevisionToolParser();
    }
    ...
    public CommandResult execute(String commandText) throws CommandException, ParseException {
        ...
        Command command = revisionToolParser.parseCommand(commandText);
